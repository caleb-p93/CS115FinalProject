...
namespace DeliciosoERistorante                     // project namespace
{
    public partial class frmReceipt : Form         // class name
    {
        ...
        private void frmReceipt_Load(object sender, EventArgs e)   // load event for proportional resizing
        {
        ...
        private void frmReceipt_Resize(object sender, EventArgs e) // resize event for proportional scaling
        {
