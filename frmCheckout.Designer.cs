namespace DeliciosoERistorante                                     // namespace declaration
{ 
    partial class frmCheckout                                      // partial class frmCheckout
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmCheckout)); // resource manager
            ...
            this.lblPaymentMethod = new System.Windows.Forms.Label(); // label payment method
            this.radCash = new System.Windows.Forms.RadioButton(); // radio cash
            this.gbxItemizedBill.SuspendLayout();                  // suspend layout for itemized bill
            this.gbxPayment.SuspendLayout();                       // suspend layout for payment
            this.SuspendLayout();                                  // suspend layout for form

            // lblYourBill
            this.lblYourBill.AutoSize = true;                      // autosize label
            ...
            this.lblYourBill.Location = new System.Drawing.Point(858, 124); // location
            ...
            // gbxItemizedBill
            this.gbxItemizedBill.BackColor = System.Drawing.Color.OldLace; // background color
            this.gbxItemizedBill.Controls.Add(this.btnCalcTotal);  // add button calculate total
            this.gbxItemizedBill.Controls.Add(this.txtTotal);      // add textbox total
            this.gbxItemizedBill.Controls.Add(this.txtTax);        // add textbox tax
            this.gbxItemizedBill.Controls.Add(this.lblTotal);      // add label total
            this.gbxItemizedBill.Controls.Add(this.lblNoTaxTip);   // add label no tax on tip
            this.gbxItemizedBill.Controls.Add(this.txtSubtotal);   // add textbox subtotal
            this.gbxItemizedBill.Controls.Add(this.txtTip);        // add textbox tip
            this.gbxItemizedBill.Controls.Add(this.lblTax);        // add label tax
            this.gbxItemizedBill.Controls.Add(this.lblTip);        // add label tip
            this.gbxItemizedBill.Controls.Add(this.lblSubtotal);   // add label subtotal
            this.gbxItemizedBill.Controls.Add(this.lstItemizedBill); // add listbox itemized bill
            this.gbxItemizedBill.Location = new System.Drawing.Point(418, 252); // location
            ...
            // btnCalcTotal
            this.btnCalcTotal.BackColor = System.Drawing.Color.Wheat; // background color
            ...
            this.btnCalcTotal.UseVisualStyleBackColor = false;     // use visual style
            this.btnCalcTotal.Click += new System.EventHandler(this.btnCalcTotal_Click); // click event

            // txtTotal
            this.txtTotal.BackColor = System.Drawing.SystemColors.Window; // background color
            ...
            // txtTax
            this.txtTax.BackColor = System.Drawing.SystemColors.Window; // background color
            ...
            // txtSubtotal
            this.txtSubtotal.BackColor = System.Drawing.SystemColors.Window; // background color
            ...
            // lstItemizedBill
            this.lstItemizedBill.BorderStyle = System.Windows.Forms.BorderStyle.None; // border style
            ...
            // gbxPayment
            this.gbxPayment.BackColor = System.Drawing.Color.OldLace; // background color
            this.gbxPayment.Controls.Add(this.txtCustName); // add textbox customer name
            this.gbxPayment.Controls.Add(this.lblCustName); // add label customer name
            this.gbxPayment.Controls.Add(this.btnPayment);  // add button submit payment
            this.gbxPayment.Controls.Add(this.txtPin);      // add textbox pin
            this.gbxPayment.Controls.Add(this.lblPin);      // add label pin
            this.gbxPayment.Controls.Add(this.txtExpireDate); // add textbox expiration date
            this.gbxPayment.Controls.Add(this.lblExpireDate); // add label expiration date
            this.gbxPayment.Controls.Add(this.txtCardNumber); // add textbox card number
            this.gbxPayment.Controls.Add(this.lblCardNumber); // add label card number
            this.gbxPayment.Controls.Add(this.radDebitCard); // add radio debit card
            this.gbxPayment.Controls.Add(this.radCreditCard); // add radio credit card
            this.gbxPayment.Controls.Add(this.lblPaymentMethod); // add label payment method
            this.gbxPayment.Controls.Add(this.radCash);     // add radio cash
            this.gbxPayment.Location = new System.Drawing.Point(1005, 252); // location
            ...
            // txtCustName
            this.txtCustName.BackColor = System.Drawing.SystemColors.Window; // background color
            ...
            // btnPayment
            this.btnPayment.BackColor = System.Drawing.Color.Wheat; // background color
            ...
            this.btnPayment.UseVisualStyleBackColor = false; // use visual style
            this.btnPayment.Click += new System.EventHandler(this.btnPayment_Click); // click event
            ...
            this.radDebitCard.UseVisualStyleBackColor = true;      // use visual style
            ...
            this.radCreditCard.UseVisualStyleBackColor = true;     // use visual style

            // lblPaymentMethod
            this.lblPaymentMethod.AutoSize = true;                 // autosize
            this.lblPaymentMethod.Font = new System.Drawing.Font("Palatino Linotype", 14.25F, System.Drawing.FontStyle.Bold); // font
            this.lblPaymentMethod.Location = new System.Drawing.Point(83, 30); // location
            this.lblPaymentMethod.Name = "lblPaymentMethod";        // name
            this.lblPaymentMethod.Size = new System.Drawing.Size(277, 26); // size
            this.lblPaymentMethod.TabIndex = 10;                   // tab index
            this.lblPaymentMethod.Text = "Select your payment method:"; // text
            ...
            this.radCash.UseVisualStyleBackColor = true;           // use visual style
            ...
            this.BackgroundImageLayout = System.Windows.Forms.ImageLayout.Stretch; // background layout
            this.ClientSize = new System.Drawing.Size(1920, 1080); // client size
            this.Controls.Add(this.gbxPayment);                    // add payment groupbox
            this.Controls.Add(this.gbxItemizedBill);               // add itemized bill groupbox
            this.Controls.Add(this.lblYourBill);                   // add your bill label
            ...
            this.FormBorderStyle = System.Windows.Forms.FormBorderStyle.None; // border style
            ...
            this.Load += new System.EventHandler(this.frmCheckout_Load); // load event for capturing original layout
            this.Resize += new System.EventHandler(this.frmCheckout_Resize); // resize event for proportional scaling

            this.gbxItemizedBill.ResumeLayout(false);              // resume layout itemized bill
            this.gbxItemizedBill.PerformLayout();                  // perform layout itemized bill
            this.gbxPayment.ResumeLayout(false);                   // resume layout payment
            this.gbxPayment.PerformLayout();                       // perform layout payment
            this.ResumeLayout(false);                              // resume layout form
            this.PerformLayout();                                  // perform layout form
        }
